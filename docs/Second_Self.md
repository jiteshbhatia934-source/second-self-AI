...
\# Week 1: raw captures (timestamp + unique ID) 

\# Week 2: classified + auto-linked notes 

\# Week 1: one-command capture 

\# Week 2: PARA classification via LLM 

\# Week 2: embeddings + auto-linking 

\# Week 3: nodes/edges → graph.json 

\# Week 3: exported graph data 

\# Week 4: retrieval + LLM answer 

\# Week 4: Streamlit UI (graph + search) 
